/* ----------------------------------------------------------------------------
Function: fza_fnc_SimulateBlades
...
_heli animateSource["blade1_pitch", (_blade1Output + _colletiveOut) * 0.5, true];               // Finished
_heli animateSource["blade2_pitch", (_blade2Output + _colletiveOut) * 0.5, true];               // Finished
_heli animateSource["blade3_pitch", (_blade3Output + _colletiveOut) * 0.5, true];               // Finished
_heli animateSource["blade4_pitch", (_blade4Output + _colletiveOut) * 0.5, true];               // Finished
