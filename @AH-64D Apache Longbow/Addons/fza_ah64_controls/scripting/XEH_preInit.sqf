...
//Scheduler arrays
fza_ah64_draw3Darray     = [fza_fnc_weaponTurretAim, fza_fnc_targetingPNVSControl, fza_fnc_targetingSched, fza_fnc_avionicsSlipIndicator, fza_fnc_navigationWaypointEta, fza_ihadss_fnc_ihadssController, fza_mpd_fnc_update, fza_ase_fnc_controller, fza_fnc_SimulateBlades];
